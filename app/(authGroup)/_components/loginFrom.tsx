  ...
  return (
    <Card className="w-full max-w-md border-neutral-200 shadow-lg dark:border-neutral-800">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="relative">
          <Separator />
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-2 text-xs font-medium text-neutral-500 dark:bg-neutral-950 dark:text-neutral-400">
            OR CONTINUE WITH
          </span>
        </div>
