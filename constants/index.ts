...
export const API_ROUTES = {
  ...
  TECHNICIANS: {
    ...
    ACCEPT_BOOKING: (id: string) => `/api/technician/accept-booking/${id}`,
    DECLINE_BOOKING: (id: string) => `/api/technician/decline-booking/${id}`,
    START_WORKING: (id: string) => `/api/technician/start-working-on-booking/${id}`,
    COMPLETE_BOOKING: (id: string) => `/api/technician/complete-booking/${id}`,
  },
  AVAILABILITY: {
    GET: (technicianId: string) => `/api/availability/get-all-availability?technicianId=${technicianId}`,
